Category: 02_city_architecture

Reason: Campus, streets and buildings; useful for testing line structures and perspective changes.
...
Image groups:
- set_city_1: source=download_CMU1, images=4, resolution=1500x1112, transform=none
- set_city_2: source=download_CMU2, images=4, resolution=1300x867, transform=none
- set_city_3: source=download_NSH, images=4, resolution=1300x867, transform=none