Category: 05_low_light_or_exposure_diff

Reason: Exposure-altered groups; useful for testing brightness normalization and exposure compensation.
...
Image groups:
- set_low_light_1: source=download_flower, images=4, resolution=1200x795, transform=low_light
- set_low_light_2: source=download_myself, images=4, resolution=1200x795, transform=low_light
- set_low_light_3: source=download_uav, images=4, resolution=2000x1500, transform=low_light