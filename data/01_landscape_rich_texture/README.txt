Category: 01_landscape_rich_texture

Reason: Natural or aerial scenes with rich texture; useful for testing abundant feature matching.
...
Image groups:
- set_landscape_1: source=download_CMU0, images=4, resolution=1300x867, transform=none
- set_landscape_2: source=download_CMU1, images=4, resolution=1500x1112, transform=none
- set_landscape_3: source=download_CMU2, images=4, resolution=1300x867, transform=none